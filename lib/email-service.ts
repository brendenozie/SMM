...
const SMTP_CONFIG = {
  ...
  user: process.env.SMTP_USER || "no-reply@smm.com",
...
export const emailTemplates = {
  emailVerification: (firstName: string, verificationUrl: string) => ({
    ...
    html: `
      ...
      <body>
        <div class="container">
          <div class="header">
            <img src="${process.env.NEXT_PUBLIC_APP_URL}/logo-light.png" alt="smm" class="logo">
            <h1>Welcome to smm!</h1>
          </div>
          
          <p>Hello ${firstName},</p>
          
          <p>Thank you for registering with smm! To complete your registration and access your account, please verify your email address by clicking the button below:</p>
          ...
          <div class="footer">
            <p>Best regards,<br>The smmTeam</p>
  ...
  passwordReset: (firstName: string, resetUrl: string) => ({
    subject: "Reset Your Password - smm",
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <p>We received a request to reset your password for your smmaccount. Click the button below to create a new password:</p>
...
export const sendEmail = async ({
  ...
  try {
    ...
    const fromEmail = process.env.SMTP_FROM_EMAIL || "no-reply@smm.com";
